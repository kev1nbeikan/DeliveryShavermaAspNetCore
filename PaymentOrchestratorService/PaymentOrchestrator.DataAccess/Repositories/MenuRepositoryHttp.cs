...
public class MenuRepositoryHttp : RepositoryHttpClientBase, IMenuRepository
{
    public MenuRepositoryHttp(IHttpClientFactory httpClientFactory, IOptions<ServicesOptions> options) : base(
